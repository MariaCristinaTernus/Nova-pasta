  ...
  <nav>
    ...
    <div class="form">
        <form action="../back/logIn.php" method="POST">
            ...
            <input type="email" name="Email" id="Email" class="<?php echo isset($_GET['erro']) ? 'erro' : ''; ?>">
            <?php if (isset($_GET['erro']) && $_GET['erro'] == 'email'): ?>
                <p class="mensagem-erro">Email inválido</p>
            <?php endif; ?>
            
            <label for="Senha" class="senha">Senha</label>
            <input type="password" name="Senha" id="Senha" class="<?php echo isset($_GET['erro']) ? 'erro' : ''; ?>">
